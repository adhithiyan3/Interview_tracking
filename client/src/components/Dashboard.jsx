...
const Dashboard = () => {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8 animate-fade-in">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-8">
        <div>
          <h1 className="text-3xl font-extrabold text-slate-800 flex items-center gap-2">
            Interview Dashboard <Sparkles className="w-5 h-5 text-indigo-500" />
          </h1>
        ...
        <button
          ...
          className="mt-4 md:mt-0 flex items-center justify-center space-x-2 px-5 py-3 bg-indigo-600 hover:bg-indigo-500 text-white font-bold rounded-xl shadow-lg shadow-indigo-600/20 transition-all duration-200 active:scale-[0.98] cursor-pointer"
        >
      ...
      <div className="glass-panel p-4 rounded-2xl border border-slate-200 flex flex-col md:flex-row md:items-center gap-4 mb-8 shadow-sm">
        <div className="relative flex-1">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2.5 rounded-xl glass-input text-slate-700 text-sm focus:ring-1 focus:ring-indigo-500"
          />
        </div>
        ...
        <div className="flex items-center space-x-3.5">
          ...
          <button
            ...
            className="p-2.5 rounded-xl border border-slate-200 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 hover:border-indigo-200 transition cursor-pointer"
            title="Refresh List"
          >
      ...
      {loading ? (
        ...
        <div className="glass-panel border border-slate-200 rounded-2xl p-12 text-center flex flex-col items-center max-w-xl mx-auto mt-6 shadow-sm">
          <CalendarRange className="w-16 h-16 text-indigo-300 mb-4" />
          <h3 className="text-xl font-bold text-slate-700 mb-2">No interviews found</h3>
          ...
          {(search || statusFilter !== 'All') ? (
            <button
              ...
              className="px-4 py-2 border border-slate-200 text-slate-600 hover:bg-slate-100 rounded-xl text-sm font-semibold transition cursor-pointer"
            >
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 pb-2.5 border-b border-slate-200">
              ...
              <span className="bg-indigo-50 text-indigo-600 border border-indigo-100 text-xs px-2.5 py-0.5 rounded-full font-bold">
                {upcomingInterviews.length}
              </span>
            </div>

            {upcomingInterviews.length === 0 ? (
              <div className="py-12 text-center border border-dashed border-slate-200 rounded-2xl text-slate-400 text-xs sm:text-sm">
          ...
          <div className="space-y-4">
            <div className="flex items-center space-x-2 pb-2.5 border-b border-slate-200">
              ...
              <h2 className="text-xl font-bold text-slate-800">Completed / Past</h2>
              <span className="bg-slate-100 text-slate-500 border border-slate-200 text-xs px-2.5 py-0.5 rounded-full font-bold">
