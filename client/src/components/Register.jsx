        ...
        <div>
          ...
          <div className="relative">
            ...
            <input
              ...
              placeholder="johndoe"
              className="w-full pl-11 pr-4 py-2.5 rounded-xl glass-input text-white text-sm"
              required
            />
          </div>
        </div>
